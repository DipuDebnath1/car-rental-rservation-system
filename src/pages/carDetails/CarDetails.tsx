...
const reviews = [
  { id: 1, user: "John Doe", comment: "Amazing experience!", rating: 5 },
  {
    id: 2,
    user: "Jane Smith",
    comment: "Great car and smooth ride!",
    rating: 4,
  },
];
    ...
    <div>
      {car ? (
          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="md:w-1/2 p-4">
              <h2 className="text-3xl font-bold mb-4">
                {car?.name} <small>({car?.type})</small>
              </h2>
              <p className="text-gray-600 mb-4">{car?.description}</p>
              <p className="text-gray-700 font-semibold">
                Price:{" "}
                <span className="text-blue-500">${car?.pricePerHour}/hour</span>
              </p>
        ...
        <div className="min-h-[60vh]">
          <h3 className="pt-5 text-center text-xl font-semibold">
            car not found{" "}
          </h3>
        </div>
      )}
